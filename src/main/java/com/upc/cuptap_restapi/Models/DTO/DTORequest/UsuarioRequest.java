...
public record UsuarioRequest(@NotNull @NotEmpty @NotBlank String cedula, @NotNull @NotEmpty @NotBlank String nombre,
                             @NotNull @NotEmpty @NotBlank String apellidos,
                             @NotNull @NotEmpty @NotBlank String telefono,
                             String username, String password)

        implements Serializable, RequestDTO<Usuario> {
    @Override
