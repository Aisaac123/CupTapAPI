...
import com.upc.cuptap_restapi.Controllers.Providers.Interfaces.IRController;
...
public class RController<E extends ReadEntity, ID extends Comparable<ID>> implements IRController<E, ID> {
    ...
    public ResponseEntity<Response<E>> GetById(@PathVariable ID id, @RequestParam(value = "lazy", required = false) boolean isLazy) {
        try {
