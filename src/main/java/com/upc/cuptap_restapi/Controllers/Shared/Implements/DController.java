...
import com.upc.cuptap_restapi.Controllers.Shared.Interfaces.IDController;
...
public class DController<E extends DeleteEnity, ID extends Comparable<ID>> implements IDController<E, ID> {
    ...
    public ResponseEntity<Response<E>> Delete(@PathVariable ID id, boolean transmit) {
        try {
            var response = service.Delete(id, transmit);
