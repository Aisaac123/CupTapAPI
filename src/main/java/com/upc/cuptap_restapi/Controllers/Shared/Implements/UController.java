...
import com.upc.cuptap_restapi.Controllers.Shared.Interfaces.IUController;
...
public class UController<E extends UpdateEntity, ID extends Comparable<ID>> implements IUController<E, ID> {
    ...
    public ResponseEntity<Response<Map<String, E>>> Update(@RequestBody E item, @PathVariable ID id, boolean transmit) {
        try {
            var response = service.Update(item, id, transmit);
